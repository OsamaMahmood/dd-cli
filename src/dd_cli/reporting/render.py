...
Templates ship inside the package at ``reporting/templates/``. M6a renders
Markdown only; HTML lands in M6b. PDF is intentionally not implemented —
users render the Markdown or HTML to PDF with their tool of choice
(`pandoc`, browser print, etc.). See ``docs/reporting.md``.
"""
