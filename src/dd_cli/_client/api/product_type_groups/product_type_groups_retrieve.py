...
from ...models.product_type_groups_retrieve_prefetch_item import (
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[ProductTypeGroupsRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[ProductTypeGroupsRetrievePrefetchItem] | Unset):
