...
from ...models.patched_system_settings_request import PatchedSystemSettingsRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedSystemSettingsRequest
    ...
    if isinstance(body, PatchedSystemSettingsRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedSystemSettingsRequest | Unset):
        body (PatchedSystemSettingsRequest | Unset):
        body (PatchedSystemSettingsRequest | Unset):
