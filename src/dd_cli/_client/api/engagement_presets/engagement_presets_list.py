...
from ...models.engagement_presets_list_prefetch_item import EngagementPresetsListPrefetchItem
...
def _get_kwargs(
    *,
    ...
    prefetch: list[EngagementPresetsListPrefetchItem] | Unset = UNSET,
...
) -> PaginatedEngagementPresetsList | None:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        limit (int | Unset):
        offset (int | Unset):
        prefetch (list[EngagementPresetsListPrefetchItem] | Unset):
        product (int | Unset):
        title (str | Unset):
