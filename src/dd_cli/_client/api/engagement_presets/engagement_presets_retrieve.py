...
from ...models.engagement_presets_retrieve_prefetch_item import (
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[EngagementPresetsRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[EngagementPresetsRetrievePrefetchItem] | Unset):
