...
from ...models.patched_engagement_presets_request import PatchedEngagementPresetsRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedEngagementPresetsRequest
    ...
    if isinstance(body, PatchedEngagementPresetsRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedEngagementPresetsRequest | Unset):
        body (PatchedEngagementPresetsRequest | Unset):
        body (PatchedEngagementPresetsRequest | Unset):
