...
from ...models.findings_list_created_type_1 import FindingsListCreatedType1
from ...models.findings_list_created_type_2_type_1 import FindingsListCreatedType2Type1
from ...models.findings_list_created_type_3_type_1 import FindingsListCreatedType3Type1
from ...models.findings_list_date_type_1 import FindingsListDateType1
from ...models.findings_list_jira_creation_type_1 import FindingsListJiraCreationType1
from ...models.findings_list_jira_creation_type_2_type_1 import FindingsListJiraCreationType2Type1
from ...models.findings_list_jira_creation_type_3_type_1 import FindingsListJiraCreationType3Type1
from ...models.findings_list_jira_last_update import FindingsListJiraLastUpdate
from ...models.findings_list_last_reviewed_type_1 import FindingsListLastReviewedType1
from ...models.findings_list_last_reviewed_type_2_type_1 import FindingsListLastReviewedType2Type1
from ...models.findings_list_last_reviewed_type_3_type_1 import FindingsListLastReviewedType3Type1
from ...models.findings_list_mitigated_type_1 import FindingsListMitigatedType1
from ...models.findings_list_mitigated_type_2_type_1 import FindingsListMitigatedType2Type1
from ...models.findings_list_mitigated_type_3_type_1 import FindingsListMitigatedType3Type1
...
from ...models.paginated_finding_list import PaginatedFindingList
...
def _get_kwargs(
    *,
    ...
    created: FindingsListCreatedType1
    ...
    date: FindingsListDateType1 | None | Unset = UNSET,
    ...
    jira_change: FindingsListJiraLastUpdate | None | Unset = UNSET,
    jira_creation: FindingsListJiraCreationType1
    ...
    last_reviewed: FindingsListLastReviewedType1
    ...
    mitigated: FindingsListMitigatedType1
    ...
    o: list[FindingsListOItem] | Unset = UNSET,
    ...
    prefetch: list[FindingsListPrefetchItem] | Unset = UNSET,
    ...
    if isinstance(created, Unset):
        ...
        isinstance(created, FindingsListCreatedType1)
        or isinstance(created, FindingsListCreatedType2Type1)
        or isinstance(created, FindingsListCreatedType3Type1)
    ):
    ...
    if isinstance(date, Unset):
        json_date = UNSET
    elif isinstance(date, FindingsListDateType1):
    ...
    elif isinstance(jira_change, FindingsListJiraLastUpdate):
    ...
    if isinstance(jira_creation, Unset):
        ...
        isinstance(jira_creation, FindingsListJiraCreationType1)
        or isinstance(jira_creation, FindingsListJiraCreationType2Type1)
        or isinstance(jira_creation, FindingsListJiraCreationType3Type1)
    ):
    ...
    if isinstance(last_reviewed, Unset):
        ...
        isinstance(last_reviewed, FindingsListLastReviewedType1)
        or isinstance(last_reviewed, FindingsListLastReviewedType2Type1)
        or isinstance(last_reviewed, FindingsListLastReviewedType3Type1)
    ):
    ...
    if isinstance(mitigated, Unset):
        ...
        isinstance(mitigated, FindingsListMitigatedType1)
        or isinstance(mitigated, FindingsListMitigatedType2Type1)
        or isinstance(mitigated, FindingsListMitigatedType3Type1)
    ):
...
) -> PaginatedFindingList | None:
    if response.status_code == 200:
        response_200 = PaginatedFindingList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        created (FindingsListCreatedType1 | FindingsListCreatedType2Type1 |
            FindingsListCreatedType3Type1 | None | Unset):
        cvssv3 (str | Unset):
        cvssv3_score (float | Unset):
        cvssv4 (str | Unset):
        cvssv4_score (float | Unset):
        cwe (list[int] | Unset):
        date (FindingsListDateType1 | None | Unset):
        ...
        jira_change (FindingsListJiraLastUpdate | None | Unset):
        jira_creation (FindingsListJiraCreationType1 | FindingsListJiraCreationType2Type1 |
            FindingsListJiraCreationType3Type1 | None | Unset):
        kev_date (datetime.date | Unset):
        known_exploited (bool | Unset):
        last_reviewed (FindingsListLastReviewedType1 | FindingsListLastReviewedType2Type1 |
            FindingsListLastReviewedType3Type1 | None | Unset):
        last_reviewed_by (list[int] | Unset):
        last_status_update (datetime.datetime | Unset):
        limit (int | Unset):
        mitigated (FindingsListMitigatedType1 | FindingsListMitigatedType2Type1 |
            FindingsListMitigatedType3Type1 | None | Unset):
        ...
        o (list[FindingsListOItem] | Unset):
        offset (int | Unset):
        ...
        prefetch (list[FindingsListPrefetchItem] | Unset):
