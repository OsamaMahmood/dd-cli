...
from ...models.patched_network_locations_request import PatchedNetworkLocationsRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedNetworkLocationsRequest
    ...
    if isinstance(body, PatchedNetworkLocationsRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedNetworkLocationsRequest | Unset):
        body (PatchedNetworkLocationsRequest | Unset):
        body (PatchedNetworkLocationsRequest | Unset):
