...
from ...models.jira_product_configurations_retrieve_prefetch_item import (
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[JiraProductConfigurationsRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[JiraProductConfigurationsRetrievePrefetchItem] | Unset):
