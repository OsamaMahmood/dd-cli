...
from ...models.product_type_members_retrieve_prefetch_item import (
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[ProductTypeMembersRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProductTypeMember.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[ProductTypeMembersRetrievePrefetchItem] | Unset):
