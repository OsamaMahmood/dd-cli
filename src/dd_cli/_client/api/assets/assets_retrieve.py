...
from ...models.assets_retrieve_prefetch_item import AssetsRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[AssetsRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[AssetsRetrievePrefetchItem] | Unset):
