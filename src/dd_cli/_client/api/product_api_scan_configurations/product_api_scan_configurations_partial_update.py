...
from ...models.patched_product_api_scan_configuration_request import (
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedProductAPIScanConfigurationRequest
    | PatchedProductAPIScanConfigurationRequest
    | PatchedProductAPIScanConfigurationRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedProductAPIScanConfigurationRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedProductAPIScanConfigurationRequest | Unset):
        body (PatchedProductAPIScanConfigurationRequest | Unset):
        body (PatchedProductAPIScanConfigurationRequest | Unset):
