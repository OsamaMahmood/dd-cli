...
from ...models.jira_projects_retrieve_prefetch_item import JiraProjectsRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[JiraProjectsRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[JiraProjectsRetrievePrefetchItem] | Unset):
