...
from ...models.jira_projects_list_prefetch_item import JiraProjectsListPrefetchItem
...
def _get_kwargs(
    *,
    ...
    prefetch: list[JiraProjectsListPrefetchItem] | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        limit (int | Unset):
        offset (int | Unset):
        prefetch (list[JiraProjectsListPrefetchItem] | Unset):
        product (int | Unset):
