...
from ...models.patched_sla_configuration_request import PatchedSLAConfigurationRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedSLAConfigurationRequest
    ...
    if isinstance(body, PatchedSLAConfigurationRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedSLAConfigurationRequest | Unset):
        body (PatchedSLAConfigurationRequest | Unset):
        body (PatchedSLAConfigurationRequest | Unset):
