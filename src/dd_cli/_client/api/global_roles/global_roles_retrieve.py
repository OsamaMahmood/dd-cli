...
from ...models.global_roles_retrieve_prefetch_item import GlobalRolesRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[GlobalRolesRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[GlobalRolesRetrievePrefetchItem] | Unset):
