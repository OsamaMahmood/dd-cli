...
from ...models.technologies_retrieve_prefetch_item import TechnologiesRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: list[TechnologiesRetrievePrefetchItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (list[TechnologiesRetrievePrefetchItem] | Unset):
