...
from ...models.patched_asset_api_scan_configuration_request import (
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedAssetAPIScanConfigurationRequest
    | PatchedAssetAPIScanConfigurationRequest
    | PatchedAssetAPIScanConfigurationRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedAssetAPIScanConfigurationRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedAssetAPIScanConfigurationRequest | Unset):
        body (PatchedAssetAPIScanConfigurationRequest | Unset):
        body (PatchedAssetAPIScanConfigurationRequest | Unset):
