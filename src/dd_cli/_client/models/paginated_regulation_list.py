...
T = TypeVar("T", bound="PaginatedRegulationList")


@_attrs_define
class PaginatedRegulationList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Regulation.from_dict(results_item_data)
        ...
        paginated_regulation_list.additional_properties = d
        return paginated_regulation_list
