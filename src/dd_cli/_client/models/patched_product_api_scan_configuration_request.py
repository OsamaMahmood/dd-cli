...
T = TypeVar("T", bound="PatchedProductAPIScanConfigurationRequest")


@_attrs_define
class PatchedProductAPIScanConfigurationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_product_api_scan_configuration_request = cls(
        ...
        patched_product_api_scan_configuration_request.additional_properties = d
        return patched_product_api_scan_configuration_request
