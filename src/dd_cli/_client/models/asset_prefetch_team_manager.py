...
T = TypeVar("T", bound="AssetPrefetchTeamManager")


@_attrs_define
class AssetPrefetchTeamManager:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        asset_prefetch_team_manager = cls()
        ...
        asset_prefetch_team_manager.additional_properties = additional_properties
        return asset_prefetch_team_manager
