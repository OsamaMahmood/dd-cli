...
from .. import types
from ..models.engagement_request_engagement_type_type_1 import EngagementRequestEngagementTypeType1
from ..models.engagement_request_engagement_type_type_2_type_1 import (
    EngagementRequestEngagementTypeType2Type1,
)
from ..models.engagement_request_engagement_type_type_3_type_1 import (
    EngagementRequestEngagementTypeType3Type1,
)
from ..models.engagement_request_status_type_1 import EngagementRequestStatusType1
from ..models.engagement_request_status_type_2_type_1 import EngagementRequestStatusType2Type1
from ..models.engagement_request_status_type_3_type_1 import EngagementRequestStatusType3Type1
...
class EngagementRequest:
    ...
    Attributes:
        ...
        status (EngagementRequestStatusType1 | EngagementRequestStatusType2Type1 | EngagementRequestStatusType3Type1 |
            None | Unset): * `Not Started` - Not Started
            * `Blocked` - Blocked
            * `Cancelled` - Cancelled
            * `Completed` - Completed
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            ...
            isinstance(self.status, EngagementRequestStatusType1)
            or isinstance(self.status, EngagementRequestStatusType2Type1)
            or isinstance(self.status, EngagementRequestStatusType3Type1)
        ):
        ...
        if isinstance(self.engagement_type, Unset):
            ...
            isinstance(self.engagement_type, EngagementRequestEngagementTypeType1)
            or isinstance(self.engagement_type, EngagementRequestEngagementTypeType2Type1)
            or isinstance(self.engagement_type, EngagementRequestEngagementTypeType3Type1)
        ):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.status, Unset):
            ...
            elif isinstance(self.status, EngagementRequestStatusType1) or isinstance(
                self.status, EngagementRequestStatusType2Type1
            ):
        ...
        if not isinstance(self.engagement_type, Unset):
            if self.engagement_type is None:
                ...
                self.engagement_type, EngagementRequestEngagementTypeType1
            ) or isinstance(self.engagement_type, EngagementRequestEngagementTypeType2Type1):
                files.append(
                    (
                        "engagement_type",
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = EngagementRequestStatusType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_2_type_1 = EngagementRequestStatusType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_3_type_1 = EngagementRequestStatusType3Type1(data)
        ...
        def _parse_engagement_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                engagement_type_type_1 = EngagementRequestEngagementTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                engagement_type_type_2_type_1 = EngagementRequestEngagementTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                engagement_type_type_3_type_1 = EngagementRequestEngagementTypeType3Type1(data)
