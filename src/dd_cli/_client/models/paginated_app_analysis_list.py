...
if TYPE_CHECKING:
    ...
    from ..models.paginated_app_analysis_list_prefetch import PaginatedAppAnalysisListPrefetch
...
class PaginatedAppAnalysisList:
    ...
    Attributes:
        ...
        prefetch (PaginatedAppAnalysisListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedAppAnalysisListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedAppAnalysisListPrefetch.from_dict(_prefetch)
