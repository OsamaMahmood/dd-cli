...
T = TypeVar("T", bound="EngagementUpdateJiraEpic")


@_attrs_define
class EngagementUpdateJiraEpic:
    """
    Attributes:
        epic_name (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        engagement_update_jira_epic = cls(
            epic_name=epic_name,
            epic_priority=epic_priority,
        )

        engagement_update_jira_epic.additional_properties = d
        return engagement_update_jira_epic
