...
T = TypeVar("T", bound="PatchedTestRequest")


@_attrs_define
class PatchedTestRequest:
    """
    Attributes:
        tags (list[str] | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_target_start, Unset):
            ...
            target_start = isoparse(_target_start)
        ...
        if isinstance(_target_end, Unset):
            ...
            target_end = isoparse(_target_end)
        ...
        patched_test_request.additional_properties = d
        return patched_test_request
