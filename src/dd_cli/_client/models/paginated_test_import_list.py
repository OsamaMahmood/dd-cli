...
T = TypeVar("T", bound="PaginatedTestImportList")


@_attrs_define
class PaginatedTestImportList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TestImport.from_dict(results_item_data)
        ...
        paginated_test_import_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_test_import_list.additional_properties = d
        return paginated_test_import_list
