...
T = TypeVar("T", bound="SLAConfigurationRequest")


@_attrs_define
class SLAConfigurationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sla_configuration_request.additional_properties = d
        return sla_configuration_request
