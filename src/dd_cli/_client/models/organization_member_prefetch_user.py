...
T = TypeVar("T", bound="OrganizationMemberPrefetchUser")


@_attrs_define
class OrganizationMemberPrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        organization_member_prefetch_user = cls()
        ...
        organization_member_prefetch_user.additional_properties = additional_properties
        return organization_member_prefetch_user
