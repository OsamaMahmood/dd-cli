...
T = TypeVar("T", bound="FindingPrefetchEndpoints")


@_attrs_define
class FindingPrefetchEndpoints:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_endpoints = cls()
        ...
        finding_prefetch_endpoints.additional_properties = additional_properties
        return finding_prefetch_endpoints
