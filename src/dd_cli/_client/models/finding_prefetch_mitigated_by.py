...
T = TypeVar("T", bound="FindingPrefetchMitigatedBy")


@_attrs_define
class FindingPrefetchMitigatedBy:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_mitigated_by = cls()
        ...
        finding_prefetch_mitigated_by.additional_properties = additional_properties
        return finding_prefetch_mitigated_by
