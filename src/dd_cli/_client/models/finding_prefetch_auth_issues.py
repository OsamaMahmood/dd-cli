...
T = TypeVar("T", bound="FindingPrefetchAuthIssues")


@_attrs_define
class FindingPrefetchAuthIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_auth_issues = cls()
        ...
        finding_prefetch_auth_issues.additional_properties = additional_properties
        return finding_prefetch_auth_issues
