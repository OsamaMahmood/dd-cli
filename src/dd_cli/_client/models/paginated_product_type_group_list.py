...
if TYPE_CHECKING:
    from ..models.paginated_product_type_group_list_prefetch import (
        PaginatedProductTypeGroupListPrefetch,
    )
    from ..models.product_type_group import ProductTypeGroup


T = TypeVar("T", bound="PaginatedProductTypeGroupList")


@_attrs_define
class PaginatedProductTypeGroupList:
    """
    Attributes:
        ...
        prefetch (PaginatedProductTypeGroupListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedProductTypeGroupListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProductTypeGroup.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedProductTypeGroupListPrefetch.from_dict(_prefetch)

        paginated_product_type_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_product_type_group_list.additional_properties = d
        return paginated_product_type_group_list
