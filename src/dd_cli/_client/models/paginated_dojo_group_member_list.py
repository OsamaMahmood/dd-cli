...
if TYPE_CHECKING:
    ...
    from ..models.paginated_dojo_group_member_list_prefetch import (
        PaginatedDojoGroupMemberListPrefetch,
    )


T = TypeVar("T", bound="PaginatedDojoGroupMemberList")


@_attrs_define
class PaginatedDojoGroupMemberList:
    """
    Attributes:
        ...
        prefetch (PaginatedDojoGroupMemberListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedDojoGroupMemberListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DojoGroupMember.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedDojoGroupMemberListPrefetch.from_dict(_prefetch)

        paginated_dojo_group_member_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_dojo_group_member_list.additional_properties = d
        return paginated_dojo_group_member_list
