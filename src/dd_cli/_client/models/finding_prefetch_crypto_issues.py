...
T = TypeVar("T", bound="FindingPrefetchCryptoIssues")


@_attrs_define
class FindingPrefetchCryptoIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_crypto_issues = cls()
        ...
        finding_prefetch_crypto_issues.additional_properties = additional_properties
        return finding_prefetch_crypto_issues
