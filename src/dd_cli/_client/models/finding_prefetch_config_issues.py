...
T = TypeVar("T", bound="FindingPrefetchConfigIssues")


@_attrs_define
class FindingPrefetchConfigIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_config_issues = cls()
        ...
        finding_prefetch_config_issues.additional_properties = additional_properties
        return finding_prefetch_config_issues
