...
T = TypeVar("T", bound="FindingPrefetchSensitiveIssues")


@_attrs_define
class FindingPrefetchSensitiveIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_sensitive_issues = cls()
        ...
        finding_prefetch_sensitive_issues.additional_properties = additional_properties
        return finding_prefetch_sensitive_issues
