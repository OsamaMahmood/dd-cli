...
T = TypeVar("T", bound="PaginatedQuestionnaireEngagementSurveyList")


@_attrs_define
class PaginatedQuestionnaireEngagementSurveyList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = QuestionnaireEngagementSurvey.from_dict(results_item_data)
        ...
        paginated_questionnaire_engagement_survey_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_questionnaire_engagement_survey_list.additional_properties = d
        return paginated_questionnaire_engagement_survey_list
