...
T = TypeVar("T", bound="PatchedAssetAPIScanConfigurationRequest")


@_attrs_define
class PatchedAssetAPIScanConfigurationRequest:
    """
    Attributes:
        asset (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_asset_api_scan_configuration_request = cls(
            asset=asset,
        ...
        patched_asset_api_scan_configuration_request.additional_properties = d
        return patched_asset_api_scan_configuration_request
