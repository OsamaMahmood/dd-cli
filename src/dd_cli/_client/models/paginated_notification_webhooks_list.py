...
T = TypeVar("T", bound="PaginatedNotificationWebhooksList")


@_attrs_define
class PaginatedNotificationWebhooksList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = NotificationWebhooks.from_dict(results_item_data)
        ...
        paginated_notification_webhooks_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_notification_webhooks_list.additional_properties = d
        return paginated_notification_webhooks_list
