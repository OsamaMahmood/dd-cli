...
T = TypeVar("T", bound="AppAnalysisPrefetchUser")


@_attrs_define
class AppAnalysisPrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        app_analysis_prefetch_user = cls()
        ...
        app_analysis_prefetch_user.additional_properties = additional_properties
        return app_analysis_prefetch_user
