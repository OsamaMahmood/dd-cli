...
T = TypeVar("T", bound="PaginatedSystemSettingsList")


@_attrs_define
class PaginatedSystemSettingsList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SystemSettings.from_dict(results_item_data)
        ...
        paginated_system_settings_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_system_settings_list.additional_properties = d
        return paginated_system_settings_list
