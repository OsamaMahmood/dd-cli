...
if TYPE_CHECKING:
    from ..models.paginated_user_contact_info_list_prefetch import (
        PaginatedUserContactInfoListPrefetch,
    )
    from ..models.user_contact_info import UserContactInfo


T = TypeVar("T", bound="PaginatedUserContactInfoList")


@_attrs_define
class PaginatedUserContactInfoList:
    """
    Attributes:
        ...
        prefetch (PaginatedUserContactInfoListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedUserContactInfoListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = UserContactInfo.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedUserContactInfoListPrefetch.from_dict(_prefetch)

        paginated_user_contact_info_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_user_contact_info_list.additional_properties = d
        return paginated_user_contact_info_list
