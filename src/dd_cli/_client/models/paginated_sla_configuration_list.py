...
T = TypeVar("T", bound="PaginatedSLAConfigurationList")


@_attrs_define
class PaginatedSLAConfigurationList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SLAConfiguration.from_dict(results_item_data)
        ...
        paginated_sla_configuration_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_sla_configuration_list.additional_properties = d
        return paginated_sla_configuration_list
