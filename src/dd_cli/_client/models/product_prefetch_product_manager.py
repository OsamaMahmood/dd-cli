...
T = TypeVar("T", bound="ProductPrefetchProductManager")


@_attrs_define
class ProductPrefetchProductManager:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        product_prefetch_product_manager = cls()
        ...
        product_prefetch_product_manager.additional_properties = additional_properties
        return product_prefetch_product_manager
