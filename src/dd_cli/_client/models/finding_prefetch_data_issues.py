...
T = TypeVar("T", bound="FindingPrefetchDataIssues")


@_attrs_define
class FindingPrefetchDataIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_data_issues = cls()
        ...
        finding_prefetch_data_issues.additional_properties = additional_properties
        return finding_prefetch_data_issues
