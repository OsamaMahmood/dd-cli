...
T = TypeVar("T", bound="NotificationsPrefetchUser")


@_attrs_define
class NotificationsPrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        notifications_prefetch_user = cls()
        ...
        notifications_prefetch_user.additional_properties = additional_properties
        return notifications_prefetch_user
