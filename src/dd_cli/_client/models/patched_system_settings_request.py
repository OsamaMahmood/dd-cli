...
from .. import types
from ..models.patched_system_settings_request_jira_minimum_severity_type_1 import (
    PatchedSystemSettingsRequestJiraMinimumSeverityType1,
)
from ..models.patched_system_settings_request_jira_minimum_severity_type_2_type_1 import (
    PatchedSystemSettingsRequestJiraMinimumSeverityType2Type1,
)
from ..models.patched_system_settings_request_jira_minimum_severity_type_3_type_1 import (
    PatchedSystemSettingsRequestJiraMinimumSeverityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchedSystemSettingsRequest")


@_attrs_define
class PatchedSystemSettingsRequest:
    r"""
    Attributes:
        ...
        jira_minimum_severity (None | PatchedSystemSettingsRequestJiraMinimumSeverityType1 |
            PatchedSystemSettingsRequestJiraMinimumSeverityType2Type1 |
            PatchedSystemSettingsRequestJiraMinimumSeverityType3Type1 | Unset): * `Critical` - Critical
            * `High` - High
            * `Medium` - Medium
            * `Low` - Low
            * `Info` - Info
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.jira_minimum_severity, Unset):
            ...
            isinstance(
                self.jira_minimum_severity, PatchedSystemSettingsRequestJiraMinimumSeverityType1
            )
            or isinstance(
                self.jira_minimum_severity,
                PatchedSystemSettingsRequestJiraMinimumSeverityType2Type1,
            )
            or isinstance(
                self.jira_minimum_severity,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_jira_minimum_severity(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                jira_minimum_severity_type_1 = PatchedSystemSettingsRequestJiraMinimumSeverityType1(
                    data
                )
            ...
            try:
                ...
                jira_minimum_severity_type_2_type_1 = (
                    PatchedSystemSettingsRequestJiraMinimumSeverityType2Type1(data)
                )
            ...
            try:
                ...
                jira_minimum_severity_type_3_type_1 = (
                    PatchedSystemSettingsRequestJiraMinimumSeverityType3Type1(data)
                )
        ...
        patched_system_settings_request = cls(
        ...
        patched_system_settings_request.additional_properties = d
        return patched_system_settings_request
