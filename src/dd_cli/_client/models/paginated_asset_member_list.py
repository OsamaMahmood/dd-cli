...
if TYPE_CHECKING:
    ...
    from ..models.paginated_asset_member_list_prefetch import PaginatedAssetMemberListPrefetch


T = TypeVar("T", bound="PaginatedAssetMemberList")


@_attrs_define
class PaginatedAssetMemberList:
    """
    Attributes:
        ...
        prefetch (PaginatedAssetMemberListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedAssetMemberListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AssetMember.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedAssetMemberListPrefetch.from_dict(_prefetch)

        paginated_asset_member_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_asset_member_list.additional_properties = d
        return paginated_asset_member_list
