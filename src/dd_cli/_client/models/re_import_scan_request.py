...
from .. import types
from ..models.re_import_scan_request_group_by import ReImportScanRequestGroupBy
from ..models.re_import_scan_request_minimum_severity import ReImportScanRequestMinimumSeverity
from ..models.re_import_scan_request_scan_type import ReImportScanRequestScanType
from ..types import UNSET, File, FileTypes, Unset

T = TypeVar("T", bound="ReImportScanRequest")


@_attrs_define
class ReImportScanRequest:
    """
    Attributes:
        scan_type (ReImportScanRequestScanType): * `Acunetix Scan` - Acunetix Scanner
        ...
        minimum_severity (ReImportScanRequestMinimumSeverity | Unset): Minimum severity level to be imported

            * `Info` - Info
            * `Low` - Low
            * `Medium` - Medium
            * `High` - High
            * `Critical` - Critical Default: ReImportScanRequestMinimumSeverity.INFO.
        ...
        group_by (ReImportScanRequestGroupBy | Unset): Choose an option to automatically group new findings by the
            chosen option.
        ...
        do_not_reactivate (bool | Unset): Select if the import should ignore active findings from the report, useful for
            triage-less scanners. Will keep existing findings closed, without reactivating them. For more information check
            the docs. Default: False.
        test (int | Unset):
        close_old_findings (bool | Unset): Old findings no longer present in the new report get closed as mitigated when
            ...
            only findings without a service will be closed. This only affects findings within the same test. Default: True.
        close_old_findings_product_scope (bool | Unset): This has no effect on reimport Default: False.
        version (str | Unset): Version that will be set on existing Test object. Leave empty to leave existing value in
            place.
        tags (list[str] | Unset): Modify existing tags that help describe this scan. (Existing test tags will be
            overwritten)
    """

    scan_type: ReImportScanRequestScanType
    scan_date: datetime.date | Unset = UNSET
    minimum_severity: ReImportScanRequestMinimumSeverity | Unset = (
        ReImportScanRequestMinimumSeverity.INFO
    )
    ...
    group_by: ReImportScanRequestGroupBy | Unset = UNSET
    ...
    do_not_reactivate: bool | Unset = False
    test: int | Unset = UNSET
    close_old_findings: bool | Unset = True
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        do_not_reactivate = self.do_not_reactivate
        ...
        if do_not_reactivate is not UNSET:
            field_dict["do_not_reactivate"] = do_not_reactivate
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.do_not_reactivate, Unset):
            files.append(
                ("do_not_reactivate", (None, str(self.do_not_reactivate).encode(), "text/plain"))
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        scan_type = ReImportScanRequestScanType(d.pop("scan_type"))
        ...
        if isinstance(_minimum_severity, Unset):
            ...
            minimum_severity = ReImportScanRequestMinimumSeverity(_minimum_severity)
        ...
        group_by: ReImportScanRequestGroupBy | Unset
        if isinstance(_group_by, Unset):
            group_by = UNSET
        else:
            group_by = ReImportScanRequestGroupBy(_group_by)
        ...
        do_not_reactivate = d.pop("do_not_reactivate", UNSET)
        ...
        re_import_scan_request.additional_properties = d
        return re_import_scan_request
