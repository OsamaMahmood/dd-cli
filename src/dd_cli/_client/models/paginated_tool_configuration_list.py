...
if TYPE_CHECKING:
    from ..models.paginated_tool_configuration_list_prefetch import (
        PaginatedToolConfigurationListPrefetch,
    )
    from ..models.tool_configuration import ToolConfiguration


T = TypeVar("T", bound="PaginatedToolConfigurationList")


@_attrs_define
class PaginatedToolConfigurationList:
    """
    Attributes:
        ...
        prefetch (PaginatedToolConfigurationListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedToolConfigurationListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ToolConfiguration.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedToolConfigurationListPrefetch.from_dict(_prefetch)

        paginated_tool_configuration_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_tool_configuration_list.additional_properties = d
        return paginated_tool_configuration_list
