...
T = TypeVar("T", bound="ProductTypeMemberPrefetchUser")


@_attrs_define
class ProductTypeMemberPrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        product_type_member_prefetch_user = cls()
        ...
        product_type_member_prefetch_user.additional_properties = additional_properties
        return product_type_member_prefetch_user
