...
if TYPE_CHECKING:
    ...
    from ..models.paginated_dojo_group_list_prefetch import PaginatedDojoGroupListPrefetch


T = TypeVar("T", bound="PaginatedDojoGroupList")


@_attrs_define
class PaginatedDojoGroupList:
    """
    Attributes:
        ...
        prefetch (PaginatedDojoGroupListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedDojoGroupListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DojoGroup.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedDojoGroupListPrefetch.from_dict(_prefetch)

        paginated_dojo_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_dojo_group_list.additional_properties = d
        return paginated_dojo_group_list
