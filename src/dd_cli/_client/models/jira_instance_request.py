...
class JIRAInstanceRequest:
    ...
    Attributes:
        ...
        password (str): Password or API Token, see DefectDojo documentation for more information.
        ...
        default_issue_type (JIRAInstanceRequestDefaultIssueType | Unset): You can define extra issue types in
            settings.py
    ...
    default_issue_type: JIRAInstanceRequestDefaultIssueType | Unset = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        files.append(("open_status_key", (None, str(self.open_status_key).encode(), "text/plain")))
        ...
        files.append(
            ("low_mapping_severity", (None, str(self.low_mapping_severity).encode(), "text/plain"))
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_issue_type: JIRAInstanceRequestDefaultIssueType | Unset
