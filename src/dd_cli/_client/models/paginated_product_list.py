...
if TYPE_CHECKING:
    from ..models.paginated_product_list_prefetch import PaginatedProductListPrefetch
    from ..models.product import Product


T = TypeVar("T", bound="PaginatedProductList")
...
class PaginatedProductList:
    ...
    Attributes:
        ...
        prefetch (PaginatedProductListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedProductListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Product.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedProductListPrefetch.from_dict(_prefetch)

        paginated_product_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
