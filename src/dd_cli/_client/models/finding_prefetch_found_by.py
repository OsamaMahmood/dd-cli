...
T = TypeVar("T", bound="FindingPrefetchFoundBy")


@_attrs_define
class FindingPrefetchFoundBy:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        finding_prefetch_found_by.additional_properties = additional_properties
        return finding_prefetch_found_by
