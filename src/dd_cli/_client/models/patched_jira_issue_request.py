...
T = TypeVar("T", bound="PatchedJIRAIssueRequest")


@_attrs_define
class PatchedJIRAIssueRequest:
    """
    Attributes:
        jira_id (str | Unset):
        jira_key (str | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if jira_id is not UNSET:
            field_dict["jira_id"] = jira_id
        if jira_key is not UNSET:
            field_dict["jira_key"] = jira_key
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.jira_id, Unset):
            files.append(("jira_id", (None, str(self.jira_id).encode(), "text/plain")))

        if not isinstance(self.jira_key, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        jira_id = d.pop("jira_id", UNSET)

        jira_key = d.pop("jira_key", UNSET)
        ...
        patched_jira_issue_request = cls(
            jira_id=jira_id,
            jira_key=jira_key,
        ...
        patched_jira_issue_request.additional_properties = d
        return patched_jira_issue_request
