...
T = TypeVar("T", bound="PatchedProductTypeRequest")


@_attrs_define
class PatchedProductTypeRequest:
    """
    Attributes:
        name (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_product_type_request = cls(
            name=name,
        ...
        patched_product_type_request.additional_properties = d
        return patched_product_type_request
