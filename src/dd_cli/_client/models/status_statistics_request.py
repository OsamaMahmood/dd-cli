...
T = TypeVar("T", bound="StatusStatisticsRequest")


@_attrs_define
class StatusStatisticsRequest:
    """
    Attributes:
        active (int):
        verified (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status_statistics_request.additional_properties = d
        return status_statistics_request
