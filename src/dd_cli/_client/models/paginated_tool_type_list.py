...
T = TypeVar("T", bound="PaginatedToolTypeList")


@_attrs_define
class PaginatedToolTypeList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ToolType.from_dict(results_item_data)
        ...
        paginated_tool_type_list.additional_properties = d
        return paginated_tool_type_list
