...
T = TypeVar("T", bound="GlobalRolePrefetchUser")


@_attrs_define
class GlobalRolePrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_role_prefetch_user.additional_properties = additional_properties
        return global_role_prefetch_user
