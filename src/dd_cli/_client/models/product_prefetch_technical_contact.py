...
T = TypeVar("T", bound="ProductPrefetchTechnicalContact")


@_attrs_define
class ProductPrefetchTechnicalContact:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        product_prefetch_technical_contact = cls()
        ...
        product_prefetch_technical_contact.additional_properties = additional_properties
        return product_prefetch_technical_contact
