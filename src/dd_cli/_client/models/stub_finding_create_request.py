...
T = TypeVar("T", bound="StubFindingCreateRequest")


@_attrs_define
class StubFindingCreateRequest:
    """
    Attributes:
        test (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stub_finding_create_request = cls(
            test=test,
            title=title,
            date=date,
            severity=severity,
        ...
        stub_finding_create_request.additional_properties = d
        return stub_finding_create_request
