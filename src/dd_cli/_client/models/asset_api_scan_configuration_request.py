...
T = TypeVar("T", bound="AssetAPIScanConfigurationRequest")


@_attrs_define
class AssetAPIScanConfigurationRequest:
    """
    Attributes:
        asset (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_api_scan_configuration_request = cls(
            asset=asset,
            tool_configuration=tool_configuration,
        ...
        asset_api_scan_configuration_request.additional_properties = d
        return asset_api_scan_configuration_request
