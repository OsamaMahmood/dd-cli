...
T = TypeVar("T", bound="DojoGroupPrefetchUsers")


@_attrs_define
class DojoGroupPrefetchUsers:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dojo_group_prefetch_users.additional_properties = additional_properties
        return dojo_group_prefetch_users
