...
T = TypeVar("T", bound="PaginatedFindingListPrefetchAuthIssues")


@_attrs_define
class PaginatedFindingListPrefetchAuthIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        paginated_finding_list_prefetch_auth_issues = cls()
        ...
        paginated_finding_list_prefetch_auth_issues.additional_properties = additional_properties
        return paginated_finding_list_prefetch_auth_issues
