...
T = TypeVar("T", bound="ProductPrefetchProdType")


@_attrs_define
class ProductPrefetchProdType:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        product_prefetch_prod_type = cls()
        ...
        product_prefetch_prod_type.additional_properties = additional_properties
        return product_prefetch_prod_type
