...
from ..models.re_import_scan_group_by import ReImportScanGroupBy
from ..models.re_import_scan_minimum_severity import ReImportScanMinimumSeverity
from ..models.re_import_scan_scan_type import ReImportScanScanType
...
T = TypeVar("T", bound="ReImportScan")
...
class ReImportScan:
    ...
    Attributes:
        test_id (int):
        engagement_id (int):
        product_id (int): Also referred to as 'Asset' ID.
        product_type_id (int): Also referred to as 'Organization' ID.
        statistics (ImportStatistics):
        pro (list[Any]):
        scan_type (ReImportScanScanType): * `Acunetix Scan` - Acunetix Scanner
        ...
        minimum_severity (ReImportScanMinimumSeverity | Unset): Minimum severity level to be imported

            * `Info` - Info
            * `Low` - Low
            * `Medium` - Medium
            * `High` - High
            * `Critical` - Critical Default: ReImportScanMinimumSeverity.INFO.
        ...
        group_by (ReImportScanGroupBy | Unset): Choose an option to automatically group new findings by the chosen
            option.
    ...
    statistics: ImportStatistics
    pro: list[Any]
    scan_type: ReImportScanScanType
    scan_date: datetime.date | Unset = UNSET
    minimum_severity: ReImportScanMinimumSeverity | Unset = ReImportScanMinimumSeverity.INFO
    ...
    group_by: ReImportScanGroupBy | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        statistics = ImportStatistics.from_dict(d.pop("statistics"))

        pro = cast(list[Any], d.pop("pro"))

        scan_type = ReImportScanScanType(d.pop("scan_type"))
        ...
        minimum_severity: ReImportScanMinimumSeverity | Unset
        if isinstance(_minimum_severity, Unset):
            minimum_severity = UNSET
        else:
            minimum_severity = ReImportScanMinimumSeverity(_minimum_severity)
        ...
        group_by: ReImportScanGroupBy | Unset
        if isinstance(_group_by, Unset):
            group_by = UNSET
        else:
            group_by = ReImportScanGroupBy(_group_by)
        ...
        re_import_scan.additional_properties = d
        return re_import_scan
