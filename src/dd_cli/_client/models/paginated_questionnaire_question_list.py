...
if TYPE_CHECKING:
    from ..models.questionnaire_question import QuestionnaireQuestion


T = TypeVar("T", bound="PaginatedQuestionnaireQuestionList")


@_attrs_define
class PaginatedQuestionnaireQuestionList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = QuestionnaireQuestion.from_dict(results_item_data)
        ...
        paginated_questionnaire_question_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_questionnaire_question_list.additional_properties = d
        return paginated_questionnaire_question_list
