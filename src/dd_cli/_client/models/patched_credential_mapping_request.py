...
T = TypeVar("T", bound="PatchedCredentialMappingRequest")


@_attrs_define
class PatchedCredentialMappingRequest:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if url is not UNSET:
            field_dict["url"] = url
        if cred_id is not UNSET:
            field_dict["cred_id"] = cred_id
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.cred_id, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_credential_mapping_request = cls(
        ...
        patched_credential_mapping_request.additional_properties = d
        return patched_credential_mapping_request
