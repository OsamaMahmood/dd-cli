...
T = TypeVar("T", bound="PaginatedStubFindingList")


@_attrs_define
class PaginatedStubFindingList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = StubFinding.from_dict(results_item_data)
        ...
        paginated_stub_finding_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_stub_finding_list.additional_properties = d
        return paginated_stub_finding_list
