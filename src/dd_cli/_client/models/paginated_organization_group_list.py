...
if TYPE_CHECKING:
    ...
    from ..models.paginated_organization_group_list_prefetch import (
        PaginatedOrganizationGroupListPrefetch,
    )


T = TypeVar("T", bound="PaginatedOrganizationGroupList")


@_attrs_define
class PaginatedOrganizationGroupList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[OrganizationGroup]):
        ...
        prefetch (PaginatedOrganizationGroupListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedOrganizationGroupListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = OrganizationGroup.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedOrganizationGroupListPrefetch.from_dict(_prefetch)

        paginated_organization_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_organization_group_list.additional_properties = d
        return paginated_organization_group_list
