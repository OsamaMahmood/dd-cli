...
T = TypeVar("T", bound="PatchedTestImportRequest")


@_attrs_define
class PatchedTestImportRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_test_import_request = cls(
        ...
        patched_test_import_request.additional_properties = d
        return patched_test_import_request
