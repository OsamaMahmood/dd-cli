...
T = TypeVar("T", bound="ProductTypePrefetchMembers")


@_attrs_define
class ProductTypePrefetchMembers:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        product_type_prefetch_members = cls()
        ...
        product_type_prefetch_members.additional_properties = additional_properties
        return product_type_prefetch_members
