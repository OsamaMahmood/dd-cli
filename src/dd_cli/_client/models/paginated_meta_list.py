...
T = TypeVar("T", bound="PaginatedMetaList")


@_attrs_define
class PaginatedMetaList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Meta.from_dict(results_item_data)
        ...
        paginated_meta_list.additional_properties = d
        return paginated_meta_list
