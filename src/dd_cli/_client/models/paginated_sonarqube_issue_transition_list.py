...
T = TypeVar("T", bound="PaginatedSonarqubeIssueTransitionList")


@_attrs_define
class PaginatedSonarqubeIssueTransitionList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SonarqubeIssueTransition.from_dict(results_item_data)
        ...
        paginated_sonarqube_issue_transition_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_sonarqube_issue_transition_list.additional_properties = d
        return paginated_sonarqube_issue_transition_list
