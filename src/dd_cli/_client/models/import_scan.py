...
from ..models.import_scan_group_by import ImportScanGroupBy
from ..models.import_scan_minimum_severity import ImportScanMinimumSeverity
from ..models.import_scan_scan_type import ImportScanScanType
...
class ImportScan:
    ...
    Attributes:
        ...
        pro (list[Any]):
        scan_type (ImportScanScanType): * `Acunetix Scan` - Acunetix Scanner
        ...
        minimum_severity (ImportScanMinimumSeverity | Unset): Minimum severity level to be imported

            * `Info` - Info
            * `Low` - Low
            * `Medium` - Medium
            * `High` - High
            * `Critical` - Critical Default: ImportScanMinimumSeverity.INFO.
        ...
        group_by (ImportScanGroupBy | Unset): Choose an option to automatically group new findings by the chosen option.
    ...
    statistics: ImportStatistics
    pro: list[Any]
    scan_type: ImportScanScanType
    test: int
    scan_date: datetime.date | Unset = UNSET
    minimum_severity: ImportScanMinimumSeverity | Unset = ImportScanMinimumSeverity.INFO
    ...
    group_by: ImportScanGroupBy | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scan_type = ImportScanScanType(d.pop("scan_type"))
        ...
        minimum_severity: ImportScanMinimumSeverity | Unset
        if isinstance(_minimum_severity, Unset):
            minimum_severity = UNSET
        else:
            minimum_severity = ImportScanMinimumSeverity(_minimum_severity)
        ...
        group_by: ImportScanGroupBy | Unset
        if isinstance(_group_by, Unset):
            group_by = UNSET
        else:
            group_by = ImportScanGroupBy(_group_by)
        ...
        import_scan.additional_properties = d
        return import_scan
