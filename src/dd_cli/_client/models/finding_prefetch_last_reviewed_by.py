...
T = TypeVar("T", bound="FindingPrefetchLastReviewedBy")


@_attrs_define
class FindingPrefetchLastReviewedBy:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_last_reviewed_by = cls()
        ...
        finding_prefetch_last_reviewed_by.additional_properties = additional_properties
        return finding_prefetch_last_reviewed_by
