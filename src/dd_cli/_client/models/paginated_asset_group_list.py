...
if TYPE_CHECKING:
    ...
    from ..models.paginated_asset_group_list_prefetch import PaginatedAssetGroupListPrefetch


T = TypeVar("T", bound="PaginatedAssetGroupList")


@_attrs_define
class PaginatedAssetGroupList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[AssetGroup]):
        ...
        prefetch (PaginatedAssetGroupListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedAssetGroupListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AssetGroup.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedAssetGroupListPrefetch.from_dict(_prefetch)

        paginated_asset_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_asset_group_list.additional_properties = d
        return paginated_asset_group_list
