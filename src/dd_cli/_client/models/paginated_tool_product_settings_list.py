...
if TYPE_CHECKING:
    from ..models.paginated_tool_product_settings_list_prefetch import (
        PaginatedToolProductSettingsListPrefetch,
    )
    from ..models.tool_product_settings import ToolProductSettings


T = TypeVar("T", bound="PaginatedToolProductSettingsList")


@_attrs_define
class PaginatedToolProductSettingsList:
    """
    Attributes:
        ...
        prefetch (PaginatedToolProductSettingsListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedToolProductSettingsListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ToolProductSettings.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedToolProductSettingsListPrefetch.from_dict(_prefetch)

        paginated_tool_product_settings_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_tool_product_settings_list.additional_properties = d
        return paginated_tool_product_settings_list
