...
T = TypeVar("T", bound="ProductPrefetchTeamManager")


@_attrs_define
class ProductPrefetchTeamManager:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        product_prefetch_team_manager = cls()
        ...
        product_prefetch_team_manager.additional_properties = additional_properties
        return product_prefetch_team_manager
