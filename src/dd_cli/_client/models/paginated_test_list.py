...
T = TypeVar("T", bound="PaginatedTestList")


@_attrs_define
class PaginatedTestList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Test.from_dict(results_item_data)
        ...
        paginated_test_list.additional_properties = d
        return paginated_test_list
