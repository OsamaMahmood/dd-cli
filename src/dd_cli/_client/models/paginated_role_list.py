...
T = TypeVar("T", bound="PaginatedRoleList")
...
class PaginatedRoleList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Role.from_dict(results_item_data)
        ...
        paginated_role_list.additional_properties = d
        return paginated_role_list
