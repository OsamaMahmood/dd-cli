...
T = TypeVar("T", bound="DojoGroupMemberPrefetchUser")


@_attrs_define
class DojoGroupMemberPrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        dojo_group_member_prefetch_user = cls()
        ...
        dojo_group_member_prefetch_user.additional_properties = additional_properties
        return dojo_group_member_prefetch_user
