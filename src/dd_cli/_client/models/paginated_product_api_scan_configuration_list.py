...
if TYPE_CHECKING:
    from ..models.paginated_product_api_scan_configuration_list_prefetch import (
...
T = TypeVar("T", bound="PaginatedProductAPIScanConfigurationList")


@_attrs_define
class PaginatedProductAPIScanConfigurationList:
    """
    Attributes:
        ...
        prefetch (PaginatedProductAPIScanConfigurationListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedProductAPIScanConfigurationListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProductAPIScanConfiguration.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedProductAPIScanConfigurationListPrefetch.from_dict(_prefetch)

        paginated_product_api_scan_configuration_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_product_api_scan_configuration_list.additional_properties = d
        return paginated_product_api_scan_configuration_list
