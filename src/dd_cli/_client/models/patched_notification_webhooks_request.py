...
T = TypeVar("T", bound="PatchedNotificationWebhooksRequest")


@_attrs_define
class PatchedNotificationWebhooksRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_notification_webhooks_request = cls(
            name=name,
            url=url,
        ...
        patched_notification_webhooks_request.additional_properties = d
        return patched_notification_webhooks_request
