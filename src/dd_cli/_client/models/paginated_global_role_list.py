...
if TYPE_CHECKING:
    ...
    from ..models.paginated_global_role_list_prefetch import PaginatedGlobalRoleListPrefetch
...
class PaginatedGlobalRoleList:
    ...
    Attributes:
        ...
        prefetch (PaginatedGlobalRoleListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedGlobalRoleListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedGlobalRoleListPrefetch.from_dict(_prefetch)
