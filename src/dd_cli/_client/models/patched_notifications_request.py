...
from .. import types
from ..models.patched_notifications_request_auto_close_engagement_item import (
    PatchedNotificationsRequestAutoCloseEngagementItem,
)
from ..models.patched_notifications_request_close_engagement_item import (
    PatchedNotificationsRequestCloseEngagementItem,
)
from ..models.patched_notifications_request_code_review_item import (
    PatchedNotificationsRequestCodeReviewItem,
)
from ..models.patched_notifications_request_engagement_added_item import (
    PatchedNotificationsRequestEngagementAddedItem,
)
from ..models.patched_notifications_request_jira_update_item import (
    PatchedNotificationsRequestJiraUpdateItem,
)
from ..models.patched_notifications_request_other_item import PatchedNotificationsRequestOtherItem
from ..models.patched_notifications_request_product_added_item import (
    PatchedNotificationsRequestProductAddedItem,
)
from ..models.patched_notifications_request_product_type_added_item import (
    PatchedNotificationsRequestProductTypeAddedItem,
)
from ..models.patched_notifications_request_review_requested_item import (
    PatchedNotificationsRequestReviewRequestedItem,
)
from ..models.patched_notifications_request_risk_acceptance_expiration_item import (
    PatchedNotificationsRequestRiskAcceptanceExpirationItem,
)
from ..models.patched_notifications_request_scan_added_empty import (
    PatchedNotificationsRequestScanAddedEmpty,
)
from ..models.patched_notifications_request_scan_added_item import (
    PatchedNotificationsRequestScanAddedItem,
)
from ..models.patched_notifications_request_sla_breach_combined_item import (
    PatchedNotificationsRequestSlaBreachCombinedItem,
)
from ..models.patched_notifications_request_sla_breach_item import (
    PatchedNotificationsRequestSlaBreachItem,
)
from ..models.patched_notifications_request_stale_engagement_item import (
    PatchedNotificationsRequestStaleEngagementItem,
)
from ..models.patched_notifications_request_test_added_item import (
    PatchedNotificationsRequestTestAddedItem,
)
from ..models.patched_notifications_request_upcoming_engagement_item import (
    PatchedNotificationsRequestUpcomingEngagementItem,
)
from ..models.patched_notifications_request_user_mentioned_item import (
    PatchedNotificationsRequestUserMentionedItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchedNotificationsRequest")


@_attrs_define
class PatchedNotificationsRequest:
    """
    Attributes:
        product (int | None | Unset):
        user (int | None | Unset):
        product_type_added (list[PatchedNotificationsRequestProductTypeAddedItem] | Unset):
        product_added (list[PatchedNotificationsRequestProductAddedItem] | Unset):
        engagement_added (list[PatchedNotificationsRequestEngagementAddedItem] | Unset):
        test_added (list[PatchedNotificationsRequestTestAddedItem] | Unset):
        scan_added (list[PatchedNotificationsRequestScanAddedItem] | Unset):
        jira_update (list[PatchedNotificationsRequestJiraUpdateItem] | Unset):
        upcoming_engagement (list[PatchedNotificationsRequestUpcomingEngagementItem] | Unset):
        stale_engagement (list[PatchedNotificationsRequestStaleEngagementItem] | Unset):
        auto_close_engagement (list[PatchedNotificationsRequestAutoCloseEngagementItem] | Unset):
        close_engagement (list[PatchedNotificationsRequestCloseEngagementItem] | Unset):
        user_mentioned (list[PatchedNotificationsRequestUserMentionedItem] | Unset):
        code_review (list[PatchedNotificationsRequestCodeReviewItem] | Unset):
        review_requested (list[PatchedNotificationsRequestReviewRequestedItem] | Unset):
        other (list[PatchedNotificationsRequestOtherItem] | Unset):
        sla_breach (list[PatchedNotificationsRequestSlaBreachItem] | Unset):
        sla_breach_combined (list[PatchedNotificationsRequestSlaBreachCombinedItem] | Unset):
        risk_acceptance_expiration (list[PatchedNotificationsRequestRiskAcceptanceExpirationItem] | Unset):
        template (bool | Unset):  Default: False.
        scan_added_empty (PatchedNotificationsRequestScanAddedEmpty | Unset): Triggered whenever an (re-)import has been
            done (even if that created/updated/closed no findings).
    ...
    product_type_added: list[PatchedNotificationsRequestProductTypeAddedItem] | Unset = UNSET
    product_added: list[PatchedNotificationsRequestProductAddedItem] | Unset = UNSET
    engagement_added: list[PatchedNotificationsRequestEngagementAddedItem] | Unset = UNSET
    test_added: list[PatchedNotificationsRequestTestAddedItem] | Unset = UNSET
    scan_added: list[PatchedNotificationsRequestScanAddedItem] | Unset = UNSET
    jira_update: list[PatchedNotificationsRequestJiraUpdateItem] | Unset = UNSET
    upcoming_engagement: list[PatchedNotificationsRequestUpcomingEngagementItem] | Unset = UNSET
    stale_engagement: list[PatchedNotificationsRequestStaleEngagementItem] | Unset = UNSET
    auto_close_engagement: list[PatchedNotificationsRequestAutoCloseEngagementItem] | Unset = UNSET
    close_engagement: list[PatchedNotificationsRequestCloseEngagementItem] | Unset = UNSET
    user_mentioned: list[PatchedNotificationsRequestUserMentionedItem] | Unset = UNSET
    code_review: list[PatchedNotificationsRequestCodeReviewItem] | Unset = UNSET
    review_requested: list[PatchedNotificationsRequestReviewRequestedItem] | Unset = UNSET
    other: list[PatchedNotificationsRequestOtherItem] | Unset = UNSET
    sla_breach: list[PatchedNotificationsRequestSlaBreachItem] | Unset = UNSET
    sla_breach_combined: list[PatchedNotificationsRequestSlaBreachCombinedItem] | Unset = UNSET
    risk_acceptance_expiration: (
        list[PatchedNotificationsRequestRiskAcceptanceExpirationItem] | Unset
    ) = UNSET
    template: bool | Unset = False
    scan_added_empty: PatchedNotificationsRequestScanAddedEmpty | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _product_type_added is not UNSET:
            ...
            for product_type_added_item_data in _product_type_added:
                product_type_added_item = PatchedNotificationsRequestProductTypeAddedItem(
        ...
        if _product_added is not UNSET:
            ...
            for product_added_item_data in _product_added:
                product_added_item = PatchedNotificationsRequestProductAddedItem(
                    product_added_item_data
                )
        ...
        if _engagement_added is not UNSET:
            ...
            for engagement_added_item_data in _engagement_added:
                engagement_added_item = PatchedNotificationsRequestEngagementAddedItem(
        ...
        if _test_added is not UNSET:
            ...
            for test_added_item_data in _test_added:
                test_added_item = PatchedNotificationsRequestTestAddedItem(test_added_item_data)
        ...
        if _scan_added is not UNSET:
            ...
            for scan_added_item_data in _scan_added:
                scan_added_item = PatchedNotificationsRequestScanAddedItem(scan_added_item_data)
        ...
        if _jira_update is not UNSET:
            ...
            for jira_update_item_data in _jira_update:
                jira_update_item = PatchedNotificationsRequestJiraUpdateItem(jira_update_item_data)
        ...
        if _upcoming_engagement is not UNSET:
            ...
            for upcoming_engagement_item_data in _upcoming_engagement:
                upcoming_engagement_item = PatchedNotificationsRequestUpcomingEngagementItem(
        ...
        if _stale_engagement is not UNSET:
            ...
            for stale_engagement_item_data in _stale_engagement:
                stale_engagement_item = PatchedNotificationsRequestStaleEngagementItem(
        ...
        if _auto_close_engagement is not UNSET:
            ...
            for auto_close_engagement_item_data in _auto_close_engagement:
                auto_close_engagement_item = PatchedNotificationsRequestAutoCloseEngagementItem(
        ...
        if _close_engagement is not UNSET:
            ...
            for close_engagement_item_data in _close_engagement:
                close_engagement_item = PatchedNotificationsRequestCloseEngagementItem(
        ...
        if _user_mentioned is not UNSET:
            ...
            for user_mentioned_item_data in _user_mentioned:
                user_mentioned_item = PatchedNotificationsRequestUserMentionedItem(
        ...
        if _code_review is not UNSET:
            ...
            for code_review_item_data in _code_review:
                code_review_item = PatchedNotificationsRequestCodeReviewItem(code_review_item_data)
        ...
        if _review_requested is not UNSET:
            ...
            for review_requested_item_data in _review_requested:
                review_requested_item = PatchedNotificationsRequestReviewRequestedItem(
        ...
        if _other is not UNSET:
            ...
            for other_item_data in _other:
                other_item = PatchedNotificationsRequestOtherItem(other_item_data)
        ...
        if _sla_breach is not UNSET:
            ...
            for sla_breach_item_data in _sla_breach:
                sla_breach_item = PatchedNotificationsRequestSlaBreachItem(sla_breach_item_data)
        ...
        if _sla_breach_combined is not UNSET:
            ...
            for sla_breach_combined_item_data in _sla_breach_combined:
                sla_breach_combined_item = PatchedNotificationsRequestSlaBreachCombinedItem(
        ...
        if _risk_acceptance_expiration is not UNSET:
            ...
            for risk_acceptance_expiration_item_data in _risk_acceptance_expiration:
                risk_acceptance_expiration_item = (
                    PatchedNotificationsRequestRiskAcceptanceExpirationItem(
        ...
        scan_added_empty: PatchedNotificationsRequestScanAddedEmpty | Unset
        if isinstance(_scan_added_empty, Unset):
            scan_added_empty = UNSET
        else:
            scan_added_empty = PatchedNotificationsRequestScanAddedEmpty(_scan_added_empty)

        patched_notifications_request = cls(
            product=product,
            user=user,
        ...
        patched_notifications_request.additional_properties = d
        return patched_notifications_request
