...
if TYPE_CHECKING:
    ...
    from ..models.paginated_credential_list_prefetch import PaginatedCredentialListPrefetch
...
class PaginatedCredentialList:
    ...
    Attributes:
        ...
        prefetch (PaginatedCredentialListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedCredentialListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedCredentialListPrefetch.from_dict(_prefetch)
