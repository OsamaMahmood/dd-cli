...
T = TypeVar("T", bound="PaginatedTestTypeList")


@_attrs_define
class PaginatedTestTypeList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TestType.from_dict(results_item_data)
        ...
        paginated_test_type_list.additional_properties = d
        return paginated_test_type_list
