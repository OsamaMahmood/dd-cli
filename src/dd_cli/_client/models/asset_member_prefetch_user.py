...
T = TypeVar("T", bound="AssetMemberPrefetchUser")


@_attrs_define
class AssetMemberPrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        asset_member_prefetch_user = cls()
        ...
        asset_member_prefetch_user.additional_properties = additional_properties
        return asset_member_prefetch_user
