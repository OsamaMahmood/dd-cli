...
if TYPE_CHECKING:
    ...
    from ..models.paginated_notifications_list_prefetch import PaginatedNotificationsListPrefetch


T = TypeVar("T", bound="PaginatedNotificationsList")


@_attrs_define
class PaginatedNotificationsList:
    """
    Attributes:
        ...
        prefetch (PaginatedNotificationsListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedNotificationsListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.notifications import Notifications
        from ..models.paginated_notifications_list_prefetch import (
        ...
        for results_item_data in _results:
            results_item = Notifications.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedNotificationsListPrefetch.from_dict(_prefetch)

        paginated_notifications_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_notifications_list.additional_properties = d
        return paginated_notifications_list
