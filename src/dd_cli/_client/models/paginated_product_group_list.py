...
if TYPE_CHECKING:
    from ..models.paginated_product_group_list_prefetch import PaginatedProductGroupListPrefetch
    from ..models.product_group import ProductGroup


T = TypeVar("T", bound="PaginatedProductGroupList")


@_attrs_define
class PaginatedProductGroupList:
    """
    Attributes:
        ...
        prefetch (PaginatedProductGroupListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedProductGroupListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProductGroup.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedProductGroupListPrefetch.from_dict(_prefetch)

        paginated_product_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_product_group_list.additional_properties = d
        return paginated_product_group_list
