...
if TYPE_CHECKING:
    from ..models.paginated_product_type_member_list_prefetch import (
        PaginatedProductTypeMemberListPrefetch,
    )
    from ..models.product_type_member import ProductTypeMember


T = TypeVar("T", bound="PaginatedProductTypeMemberList")


@_attrs_define
class PaginatedProductTypeMemberList:
    """
    Attributes:
        ...
        prefetch (PaginatedProductTypeMemberListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedProductTypeMemberListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProductTypeMember.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedProductTypeMemberListPrefetch.from_dict(_prefetch)

        paginated_product_type_member_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_product_type_member_list.additional_properties = d
        return paginated_product_type_member_list
