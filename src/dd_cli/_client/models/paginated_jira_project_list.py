...
if TYPE_CHECKING:
    ...
    from ..models.paginated_jira_project_list_prefetch import PaginatedJIRAProjectListPrefetch
...
class PaginatedJIRAProjectList:
    ...
    Attributes:
        ...
        prefetch (PaginatedJIRAProjectListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedJIRAProjectListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedJIRAProjectListPrefetch.from_dict(_prefetch)
