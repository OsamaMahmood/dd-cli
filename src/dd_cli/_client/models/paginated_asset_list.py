...
if TYPE_CHECKING:
    ...
    from ..models.paginated_asset_list_prefetch import PaginatedAssetListPrefetch
...
class PaginatedAssetList:
    ...
    Attributes:
        ...
        prefetch (PaginatedAssetListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedAssetListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Asset.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedAssetListPrefetch.from_dict(_prefetch)
