...
from .. import types
from ..models.risk_acceptance_request_decision import RiskAcceptanceRequestDecision
from ..models.risk_acceptance_request_security_recommendation import (
...
class RiskAcceptanceRequest:
    ...
    Attributes:
        ...
        recommendation (RiskAcceptanceRequestSecurityRecommendation | Unset): Recommendation from the security team.
        ...
        decision (RiskAcceptanceRequestDecision | Unset): Risk treatment decision by risk owner
    ...
    owner: int
    accepted_findings: list[int]
    recommendation: RiskAcceptanceRequestSecurityRecommendation | Unset = UNSET
    recommendation_details: None | str | Unset = UNSET
    decision: RiskAcceptanceRequestDecision | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recommendation: RiskAcceptanceRequestSecurityRecommendation | Unset
        if isinstance(_recommendation, Unset):
            recommendation = UNSET
        else:
            recommendation = RiskAcceptanceRequestSecurityRecommendation(_recommendation)
        ...
        decision: RiskAcceptanceRequestDecision | Unset
        if isinstance(_decision, Unset):
            decision = UNSET
        else:
            decision = RiskAcceptanceRequestDecision(_decision)
