...
if TYPE_CHECKING:
    from ..models.jira_project_prefetch import JIRAProjectPrefetch
...
class JIRAProject:
    ...
    Attributes:
        ...
        prefetch (JIRAProjectPrefetch | Unset):
    """
    ...
    prefetch: JIRAProjectPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = JIRAProjectPrefetch.from_dict(_prefetch)
