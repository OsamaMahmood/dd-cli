...
T = TypeVar("T", bound="PaginatedRiskAcceptanceList")


@_attrs_define
class PaginatedRiskAcceptanceList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RiskAcceptance.from_dict(results_item_data)
        ...
        paginated_risk_acceptance_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_risk_acceptance_list.additional_properties = d
        return paginated_risk_acceptance_list
