...
T = TypeVar("T", bound="FindingPrefetchReviewers")


@_attrs_define
class FindingPrefetchReviewers:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_reviewers = cls()
        ...
        finding_prefetch_reviewers.additional_properties = additional_properties
        return finding_prefetch_reviewers
