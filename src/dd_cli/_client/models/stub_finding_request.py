...
T = TypeVar("T", bound="StubFindingRequest")


@_attrs_define
class StubFindingRequest:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stub_finding_request.additional_properties = d
        return stub_finding_request
