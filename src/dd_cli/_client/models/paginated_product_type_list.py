...
if TYPE_CHECKING:
    from ..models.paginated_product_type_list_prefetch import PaginatedProductTypeListPrefetch
    from ..models.product_type import ProductType


T = TypeVar("T", bound="PaginatedProductTypeList")


@_attrs_define
class PaginatedProductTypeList:
    """
    Attributes:
        ...
        prefetch (PaginatedProductTypeListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedProductTypeListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProductType.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedProductTypeListPrefetch.from_dict(_prefetch)

        paginated_product_type_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_product_type_list.additional_properties = d
        return paginated_product_type_list
