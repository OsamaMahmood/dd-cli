...
from .. import types
from ..models.patched_announcement_request_style import PatchedAnnouncementRequestStyle
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchedAnnouncementRequest")


@_attrs_define
class PatchedAnnouncementRequest:
    """
    Attributes:
        ...
        style (PatchedAnnouncementRequestStyle | Unset): The style of banner to display. (info, success, warning,
            danger)
    ...
    style: PatchedAnnouncementRequestStyle | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        style: PatchedAnnouncementRequestStyle | Unset
        if isinstance(_style, Unset):
            style = UNSET
        else:
            style = PatchedAnnouncementRequestStyle(_style)

        dismissable = d.pop("dismissable", UNSET)

        patched_announcement_request = cls(
            message=message,
            style=style,
            dismissable=dismissable,
        )

        patched_announcement_request.additional_properties = d
        return patched_announcement_request
