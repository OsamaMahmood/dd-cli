...
T = TypeVar("T", bound="PaginatedNetworkLocationsList")


@_attrs_define
class PaginatedNetworkLocationsList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = NetworkLocations.from_dict(results_item_data)
        ...
        paginated_network_locations_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_network_locations_list.additional_properties = d
        return paginated_network_locations_list
