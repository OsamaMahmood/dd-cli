...
T = TypeVar("T", bound="OrganizationPrefetchMembers")


@_attrs_define
class OrganizationPrefetchMembers:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        organization_prefetch_members = cls()
        ...
        organization_prefetch_members.additional_properties = additional_properties
        return organization_prefetch_members
