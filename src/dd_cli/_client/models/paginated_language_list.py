...
if TYPE_CHECKING:
    ...
    from ..models.paginated_language_list_prefetch import PaginatedLanguageListPrefetch
...
class PaginatedLanguageList:
    ...
    Attributes:
        ...
        prefetch (PaginatedLanguageListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedLanguageListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedLanguageListPrefetch.from_dict(_prefetch)
