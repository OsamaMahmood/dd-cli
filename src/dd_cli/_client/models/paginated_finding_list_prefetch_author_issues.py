...
T = TypeVar("T", bound="PaginatedFindingListPrefetchAuthorIssues")


@_attrs_define
class PaginatedFindingListPrefetchAuthorIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        paginated_finding_list_prefetch_author_issues = cls()
        ...
        paginated_finding_list_prefetch_author_issues.additional_properties = additional_properties
        return paginated_finding_list_prefetch_author_issues
