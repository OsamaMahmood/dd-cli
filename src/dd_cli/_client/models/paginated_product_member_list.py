...
if TYPE_CHECKING:
    from ..models.paginated_product_member_list_prefetch import PaginatedProductMemberListPrefetch
    from ..models.product_member import ProductMember


T = TypeVar("T", bound="PaginatedProductMemberList")


@_attrs_define
class PaginatedProductMemberList:
    """
    Attributes:
        ...
        prefetch (PaginatedProductMemberListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedProductMemberListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.paginated_product_member_list_prefetch import (
        ...
        for results_item_data in _results:
            results_item = ProductMember.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedProductMemberListPrefetch.from_dict(_prefetch)

        paginated_product_member_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_product_member_list.additional_properties = d
        return paginated_product_member_list
