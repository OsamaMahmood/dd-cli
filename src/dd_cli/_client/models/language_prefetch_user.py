...
T = TypeVar("T", bound="LanguagePrefetchUser")


@_attrs_define
class LanguagePrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        language_prefetch_user.additional_properties = additional_properties
        return language_prefetch_user
