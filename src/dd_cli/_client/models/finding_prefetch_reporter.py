...
T = TypeVar("T", bound="FindingPrefetchReporter")


@_attrs_define
class FindingPrefetchReporter:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        finding_prefetch_reporter.additional_properties = additional_properties
        return finding_prefetch_reporter
