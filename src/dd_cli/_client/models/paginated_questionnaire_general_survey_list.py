...
if TYPE_CHECKING:
    from ..models.questionnaire_general_survey import QuestionnaireGeneralSurvey


T = TypeVar("T", bound="PaginatedQuestionnaireGeneralSurveyList")


@_attrs_define
class PaginatedQuestionnaireGeneralSurveyList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = QuestionnaireGeneralSurvey.from_dict(results_item_data)
        ...
        paginated_questionnaire_general_survey_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_questionnaire_general_survey_list.additional_properties = d
        return paginated_questionnaire_general_survey_list
