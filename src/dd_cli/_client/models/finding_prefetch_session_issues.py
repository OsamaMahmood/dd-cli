...
T = TypeVar("T", bound="FindingPrefetchSessionIssues")


@_attrs_define
class FindingPrefetchSessionIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_session_issues = cls()
        ...
        finding_prefetch_session_issues.additional_properties = additional_properties
        return finding_prefetch_session_issues
