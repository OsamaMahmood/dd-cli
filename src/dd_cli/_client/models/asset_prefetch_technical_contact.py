...
T = TypeVar("T", bound="AssetPrefetchTechnicalContact")


@_attrs_define
class AssetPrefetchTechnicalContact:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        asset_prefetch_technical_contact = cls()
        ...
        asset_prefetch_technical_contact.additional_properties = additional_properties
        return asset_prefetch_technical_contact
