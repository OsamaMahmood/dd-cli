...
if TYPE_CHECKING:
    ...
    from ..models.paginated_finding_list_prefetch import PaginatedFindingListPrefetch


T = TypeVar("T", bound="PaginatedFindingList")


@_attrs_define
class PaginatedFindingList:
    """
    Attributes:
        ...
        prefetch (PaginatedFindingListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedFindingListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Finding.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedFindingListPrefetch.from_dict(_prefetch)

        paginated_finding_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_finding_list.additional_properties = d
        return paginated_finding_list
