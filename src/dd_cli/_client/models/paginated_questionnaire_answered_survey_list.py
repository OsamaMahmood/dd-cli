...
if TYPE_CHECKING:
    from ..models.paginated_questionnaire_answered_survey_list_prefetch import (
...
T = TypeVar("T", bound="PaginatedQuestionnaireAnsweredSurveyList")


@_attrs_define
class PaginatedQuestionnaireAnsweredSurveyList:
    """
    Attributes:
        ...
        prefetch (PaginatedQuestionnaireAnsweredSurveyListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedQuestionnaireAnsweredSurveyListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = QuestionnaireAnsweredSurvey.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedQuestionnaireAnsweredSurveyListPrefetch.from_dict(_prefetch)

        paginated_questionnaire_answered_survey_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_questionnaire_answered_survey_list.additional_properties = d
        return paginated_questionnaire_answered_survey_list
