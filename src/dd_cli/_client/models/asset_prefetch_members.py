...
T = TypeVar("T", bound="AssetPrefetchMembers")


@_attrs_define
class AssetPrefetchMembers:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_prefetch_members.additional_properties = additional_properties
        return asset_prefetch_members
