...
T = TypeVar("T", bound="ProductMemberPrefetchUser")


@_attrs_define
class ProductMemberPrefetchUser:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        product_member_prefetch_user = cls()
        ...
        product_member_prefetch_user.additional_properties = additional_properties
        return product_member_prefetch_user
