...
if TYPE_CHECKING:
    ...
    from ..models.paginated_asset_api_scan_configuration_list_prefetch import (
        PaginatedAssetAPIScanConfigurationListPrefetch,
    )


T = TypeVar("T", bound="PaginatedAssetAPIScanConfigurationList")


@_attrs_define
class PaginatedAssetAPIScanConfigurationList:
    """
    Attributes:
        ...
        prefetch (PaginatedAssetAPIScanConfigurationListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedAssetAPIScanConfigurationListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AssetAPIScanConfiguration.from_dict(results_item_data)
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedAssetAPIScanConfigurationListPrefetch.from_dict(_prefetch)

        paginated_asset_api_scan_configuration_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_asset_api_scan_configuration_list.additional_properties = d
        return paginated_asset_api_scan_configuration_list
