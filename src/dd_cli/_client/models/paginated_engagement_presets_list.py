...
if TYPE_CHECKING:
    ...
    from ..models.paginated_engagement_presets_list_prefetch import (
...
class PaginatedEngagementPresetsList:
    ...
    Attributes:
        ...
        prefetch (PaginatedEngagementPresetsListPrefetch | Unset):
    """
    ...
    prefetch: PaginatedEngagementPresetsListPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = PaginatedEngagementPresetsListPrefetch.from_dict(_prefetch)
