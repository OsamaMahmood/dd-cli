...
T = TypeVar("T", bound="AssetPrefetchProdType")


@_attrs_define
class AssetPrefetchProdType:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_prefetch_prod_type.additional_properties = additional_properties
        return asset_prefetch_prod_type
