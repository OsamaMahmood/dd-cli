...
from .. import types
from ..models.dojo_group_request_social_authentication_provider import (
...
class DojoGroupRequest:
    ...
    Attributes:
        ...
        social_provider (DojoGroupRequestSocialAuthenticationProvider | None | Unset): Group imported from a social
            provider.
    ...
    social_provider: DojoGroupRequestSocialAuthenticationProvider | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.social_provider, DojoGroupRequestSocialAuthenticationProvider):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_social_provider(
            data: object,
        ) -> DojoGroupRequestSocialAuthenticationProvider | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                social_provider_type_1 = DojoGroupRequestSocialAuthenticationProvider(data)

                return social_provider_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DojoGroupRequestSocialAuthenticationProvider | None | Unset, data)
