...
T = TypeVar("T", bound="FindingPrefetchOtherIssues")


@_attrs_define
class FindingPrefetchOtherIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_other_issues = cls()
        ...
        finding_prefetch_other_issues.additional_properties = additional_properties
        return finding_prefetch_other_issues
