...
T = TypeVar("T", bound="FindingPrefetchAuthorIssues")


@_attrs_define
class FindingPrefetchAuthorIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        finding_prefetch_author_issues = cls()
        ...
        finding_prefetch_author_issues.additional_properties = additional_properties
        return finding_prefetch_author_issues
