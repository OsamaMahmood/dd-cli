...
T = TypeVar("T", bound="PaginatedFindingListPrefetchSessionIssues")


@_attrs_define
class PaginatedFindingListPrefetchSessionIssues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        paginated_finding_list_prefetch_session_issues = cls()
        ...
        paginated_finding_list_prefetch_session_issues.additional_properties = additional_properties
        return paginated_finding_list_prefetch_session_issues
