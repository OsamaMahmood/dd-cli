...
if TYPE_CHECKING:
    from ..models.asset_api_scan_configuration_prefetch import AssetAPIScanConfigurationPrefetch


T = TypeVar("T", bound="AssetAPIScanConfiguration")


@_attrs_define
class AssetAPIScanConfiguration:
    """
    Attributes:
        id (int):
        asset (int):
        ...
        prefetch (AssetAPIScanConfigurationPrefetch | Unset):
    """
    ...
    prefetch: AssetAPIScanConfigurationPrefetch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_prefetch, Unset):
            ...
            prefetch = AssetAPIScanConfigurationPrefetch.from_dict(_prefetch)

        asset_api_scan_configuration = cls(
            id=id,
            asset=asset,
            tool_configuration=tool_configuration,
        ...
        asset_api_scan_configuration.additional_properties = d
        return asset_api_scan_configuration
