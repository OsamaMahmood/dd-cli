...
from .. import types
from ..models.patched_tool_configuration_request_authentication_type_type_1 import (
    PatchedToolConfigurationRequestAuthenticationTypeType1,
)
from ..models.patched_tool_configuration_request_authentication_type_type_2_type_1 import (
    PatchedToolConfigurationRequestAuthenticationTypeType2Type1,
)
from ..models.patched_tool_configuration_request_authentication_type_type_3_type_1 import (
    PatchedToolConfigurationRequestAuthenticationTypeType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchedToolConfigurationRequest")


@_attrs_define
class PatchedToolConfigurationRequest:
    """
    Attributes:
        name (str | Unset):
        description (None | str | Unset):
        url (None | str | Unset):
        authentication_type (None | PatchedToolConfigurationRequestAuthenticationTypeType1 |
            PatchedToolConfigurationRequestAuthenticationTypeType2Type1 |
            PatchedToolConfigurationRequestAuthenticationTypeType3Type1 | Unset): * `API` - API Key
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.authentication_type, Unset):
            ...
            isinstance(
                self.authentication_type, PatchedToolConfigurationRequestAuthenticationTypeType1
            )
            or isinstance(
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_authentication_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                authentication_type_type_1 = PatchedToolConfigurationRequestAuthenticationTypeType1(
                    data
                )
            ...
            try:
                ...
                authentication_type_type_2_type_1 = (
                    PatchedToolConfigurationRequestAuthenticationTypeType2Type1(data)
                )
            ...
            try:
                ...
                authentication_type_type_3_type_1 = (
                    PatchedToolConfigurationRequestAuthenticationTypeType3Type1(data)
                )
        ...
        patched_tool_configuration_request = cls(
            name=name,
        ...
        patched_tool_configuration_request.additional_properties = d
        return patched_tool_configuration_request
