...
T = TypeVar("T", bound="PaginatedNoteTypeList")


@_attrs_define
class PaginatedNoteTypeList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = NoteType.from_dict(results_item_data)
        ...
        paginated_note_type_list.additional_properties = d
        return paginated_note_type_list
