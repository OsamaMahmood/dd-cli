...
class FindingTemplate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vulnerability_ids = cast(list[str], d.pop("vulnerability_ids"))

        endpoints = cast(list[str], d.pop("endpoints"))

        title = d.pop("title")

        def _parse_last_used(data: object) -> datetime.datetime | None:
            if data is None:
                return data
            try:
        ...
        def _parse_numerical_severity(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        numerical_severity = _parse_numerical_severity(d.pop("numerical_severity"))
