...
T = TypeVar("T", bound="PaginatedLanguageTypeList")


@_attrs_define
class PaginatedLanguageTypeList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = LanguageType.from_dict(results_item_data)
        ...
        paginated_language_type_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_language_type_list.additional_properties = d
        return paginated_language_type_list
