...
T = TypeVar("T", bound="QuestionnaireAnsweredSurveyPrefetchSurvey")


@_attrs_define
class QuestionnaireAnsweredSurveyPrefetchSurvey:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        questionnaire_answered_survey_prefetch_survey = cls()
        ...
        questionnaire_answered_survey_prefetch_survey.additional_properties = additional_properties
        return questionnaire_answered_survey_prefetch_survey
