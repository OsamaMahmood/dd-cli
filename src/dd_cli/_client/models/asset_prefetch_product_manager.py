...
T = TypeVar("T", bound="AssetPrefetchProductManager")


@_attrs_define
class AssetPrefetchProductManager:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        asset_prefetch_product_manager = cls()
        ...
        asset_prefetch_product_manager.additional_properties = additional_properties
        return asset_prefetch_product_manager
