...
T = TypeVar("T", bound="PatchedFindingRequest")


@_attrs_define
class PatchedFindingRequest:
    """
    Attributes:
        ...
        cvssv4_score (float | None | Unset): Numerical CVSSv4 score for the vulnerability. If the vector is given, the
            score is updated while saving the finding. The value must be between 0-10.
        severity (str | Unset): The severity level of this flaw (Critical, High, Medium, Low, Info).
        description (str | Unset): Longer more descriptive information about the flaw.
        ...
        numerical_severity (str | Unset): The numerical representation of the severity (S0, S1, S2, S3, S4).
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if numerical_severity is not UNSET:
            field_dict["numerical_severity"] = numerical_severity
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.found_by, Unset):
            for found_by_item_element in self.found_by:
                files.append(
                    ("found_by", (None, str(found_by_item_element).encode(), "text/plain"))
                )
        ...
        if not isinstance(self.numerical_severity, Unset):
            files.append(
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        found_by = cast(list[int], d.pop("found_by", UNSET))
        ...
        numerical_severity = d.pop("numerical_severity", UNSET)
        ...
        patched_finding_request.additional_properties = d
        return patched_finding_request
