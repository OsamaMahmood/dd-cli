...
class ReImportScanRequestScanType(str, Enum):
    ...
    ANCHORE_GRYPE_DETAILED = "Anchore Grype detailed"
    ...
    IRIUSRISK_THREATS_SCAN = "IriusRisk Threats Scan"
    ...
    ORCA_SECURITY_ALERTS = "Orca Security Alerts"
