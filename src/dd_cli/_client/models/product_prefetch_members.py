...
T = TypeVar("T", bound="ProductPrefetchMembers")


@_attrs_define
class ProductPrefetchMembers:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_prefetch_members.additional_properties = additional_properties
        return product_prefetch_members
